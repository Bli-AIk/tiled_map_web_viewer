...
pub(crate) struct Translations {
    ...
    pub(crate) list_search_label: String,
    pub(crate) list_search_hint: String,
    ...
    pub(crate) details_download: String,
    pub(crate) details_download_busy: String,
    pub(crate) details_download_hint: String,
...
impl Translations {
    pub(crate) fn from_i18n(i18n: &I18n) -> Self {
        Self {
            ...
            list_search_label: i18n.t("list-search-label"),
            list_search_hint: i18n.t("list-search-hint"),
            ...
            details_download: i18n.t("details-download"),
            details_download_busy: i18n.t("details-download-busy"),
            details_download_hint: i18n.t("details-download-hint"),
